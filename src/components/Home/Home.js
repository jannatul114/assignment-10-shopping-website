            ...
            <div className=" w-full my-9">
                ...
                <div className="flex bg-white" style={{ height: "600px;" }}>
                    <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
                        <div>
                            <h2 className="text-5xl font-semibold text-gray-800 md:text-5xl">2022 New Collection!!</h2>
                            ...
                            <div className="flex justify-center lg:justify-start mt-6">
                                <a className="px-4 py-3 bg-blue-600 text-gray-200 text-md font-semibold rounded hover:bg-gray-800" href="#">Explore</a>
                    ...
                    <div className="hidden lg:block lg:w-1/2" >
                        <div style={{ clipPath: "polygon(10% 0, 100% 0%, 100% 100%, 0 100%)" }} className='flex justify-center'>
                            ...
                            <img style={{}} className='h-full object-cover' src="https://images.pexels.com/photos/6764701/pexels-photo-6764701.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
